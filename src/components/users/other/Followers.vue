<template>
    <span style="float: right;">
        <v-fade-transition mode="out-in">
            <span v-if="loadingFollowers" style="float: right;">
                        ...
                        <v-card>
                            ...
                            <v-list dense style="overflow-y: scroll;">
                                <v-list-tile v-for="user in followers" :key="user.id" class="mt-2"
                                             id="#followers-users" :to="(authUserId != user.id) ? {name: 'user_profile', params: { id: user.id }} : {name: 'me_profile'}" >
                                    <v-list-tile-content>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                getUserFollowersUrl: '/users/' + this.user_id + '/followers',
